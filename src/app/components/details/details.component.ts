...
export class DetailsComponent implements OnInit, OnDestroy {
  ...
  constructor(private ActivatedRoute: ActivatedRoute, private htttpService: HttpService,) { }
  ...
  getGameDetails(id: string) {
    this.gameSub = this.htttpService.getGameDetails(id).subscribe((gameResp: Game) => {
      this.game = gameResp;
